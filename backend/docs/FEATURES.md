...
| `acwr_ratio` | `acute_load_7d / baseline` חסום 0.35–2.8; baseline = `mean×0.85 + std×0.35 + 0.5` (פנימי, לא פיצ'ר) | מחושב | 7 ימים |
...
רשימת 35 הפיצ'רים, חשיבות, והשוואת גרסאות — **רק במחברת הנספח** (לינק למעלה).
